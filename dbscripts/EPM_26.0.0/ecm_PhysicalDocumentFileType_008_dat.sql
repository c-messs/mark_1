...
--  Modified 07/20/2016 - Thomas Fidd per Anand's email Thu 7/21/2016 12:00 PM
--  Changed SBMAE to SBMAR and SBMFS to SBMIS

Merge INTO PhysicalDocumentFileType                                                                                                                             
using dual ON ( PhysicalDocumentTypeCd = 'SBMAR')                                                                                                                
when matched then                                                                                                                                               
update set PhysicalDocumentTypeNm = 'SBMAR', PhysicalDocumentTypeDscr = 'Error report sent to CCIIO for errors on approval file'                                           
When not matched then                                                                                                                                           
insert(PhysicalDocumentTypeCd,PhysicalDocumentTypeNm, PhysicalDocumentTypeDscr)                                                                                 
values ('SBMAR', 'SBMAR', 'Error report sent to CCIIO for errors on approval file');                                                                                        

Merge INTO PhysicalDocumentFileType                                                                                                                             
using dual ON ( PhysicalDocumentTypeCd = 'SBMIS')                                                                                                                
when matched then                                                                                                                                               
update set PhysicalDocumentTypeNm = 'SBMIS', PhysicalDocumentTypeDscr = 'SBM file status report sent out to CCIIO'                                           
When not matched then                                                                                                                                           
insert(PhysicalDocumentTypeCd,PhysicalDocumentTypeNm, PhysicalDocumentTypeDscr)                                                                                 
values ('SBMIS', 'SBMIS', 'SBM file status report sent out to CCIIO');                                                                                        

Merge INTO PhysicalDocumentFileType                                                                                                                             
using dual ON ( PhysicalDocumentTypeCd = 'SBMAE')                                                                                                                
when matched then                                                                                                                                               
update set PhysicalDocumentTypeNm = PhysicalDocumentTypeNm
delete where PhysicalDocumentTypeCd = 'SBMAE';                                                                                        

Merge INTO PhysicalDocumentFileType                                                                                                                             
using dual ON ( PhysicalDocumentTypeCd = 'SBMFS')                                                                                                                
when matched then                                                                                                                                               
update set PhysicalDocumentTypeNm = PhysicalDocumentTypeNm
delete where PhysicalDocumentTypeCd = 'SBMFS';
