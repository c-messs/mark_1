...
MERGE INTO INSRNCPOLICYSTATUSTYPE using dual ON ( INSURANACEPOLICYSTATUSTYPECD = '6') 
when matched then update set INSRNCPOLICYSTATUSTYPENm='SBM Void' ,INSRNCPOLICYSTATUSTYPEDesc = 'SBM Void'  
When not matched then insert(INSURANACEPOLICYSTATUSTYPECD,INSRNCPOLICYSTATUSTYPENm ,  INSRNCPOLICYSTATUSTYPEDesc) values ('6','SBM Void','SBM Void');
