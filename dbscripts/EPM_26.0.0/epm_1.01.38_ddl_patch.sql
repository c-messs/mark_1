...
RENAME COLUMN SBMRId TO SBMResponseId;

CREATE SEQUENCE SBMResponseSeq
	INCREMENT BY 1
	START WITH 1
	CACHE 10;
...
ALTER TABLE SBMResponse MODIFY(SBMFileInfoId NUMBER NULL);


ALTER TABLE SBMResponse MODIFY(SBMFileProcessingSummaryId NUMBER NOT NULL);
