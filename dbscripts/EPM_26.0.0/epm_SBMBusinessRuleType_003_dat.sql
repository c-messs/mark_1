...
MERGE INTO SBMBusinessRuleType using dual ON ( SBMBusinessRuleTypeCd = 'R065') when matched then update set SBMBusinessRuleTypeNm='Member First Name database character length truncation warning' ,SBMBusinessRuleTypeDesc = 'Member First Name database character length truncation warning'  When not matched then insert(SBMBusinessRuleTypeCd,SBMBusinessRuleTypeNm ,  SBMBusinessRuleTypeDesc) values ('R065','Member First Name database character length truncation warning','Member First Name database character length truncation warning');

MERGE INTO SBMBusinessRuleType using dual ON ( SBMBusinessRuleTypeCd = 'R066') when matched then update set SBMBusinessRuleTypeNm='Missing Member Date for Subscriber Indicator equal to Y and Non Covered Subscriber Ind. Not equal to Y error' ,SBMBusinessRuleTypeDesc = 'Missing Member Date for Subscriber Indicator equal to Y and Non Covered Subscriber Ind. Not equal to Y error'  When not matched then insert(SBMBusinessRuleTypeCd,SBMBusinessRuleTypeNm ,  SBMBusinessRuleTypeDesc) values ('R066','Missing Member Date for Subscriber Indicator equal to Y and Non Covered Subscriber Ind. Not equal to Y error','Missing Member Date for Subscriber Indicator equal to Y and Non Covered Subscriber Ind. Not equal to Y error');
