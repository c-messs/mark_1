...
MERGE INTO SbmFileStatusType using dual ON ( SbmFileStatusTypeCd = 'EXP') when matched then update set SbmFileStatusTypeNm='Expired' ,SbmFileStatusTypeDesc = 'Expired'  When not matched then insert(SbmFileStatusTypeCd,SbmFileStatusTypeNm ,  SbmFileStatusTypeDesc) values ('EXP','Expired','Expired');
