...
ALTER TABLE policyPremium
	ADD (InsrncPlanVariantCmptTypeCd VARCHAR2(25));

CREATE INDEX XIF2policyPremium ON policyPremium
(InsrncPlanVariantCmptTypeCd   ASC);

ALTER TABLE policyPremium
ADD CONSTRAINT R_379 FOREIGN KEY (InsrncPlanVariantCmptTypeCd) REFERENCES InsrncPlanVariantCmptType (InsrncPlanVariantCmptTypeCd) ON DELETE SET NULL;
