...
exec dbms_redefinition.can_redef_table('&1','TRANSMSG',dbms_redefinition.cons_use_pk);

-- Step 4
-- pause 'Start redefinition and copy data - hit return: '
exec DBMS_REDEFINITION.start_redef_table('&1', 'TRANSMSG', 'TRANSMSGTMP',null,dbms_redefinition.cons_use_pk,null,null);
...
exec DBMS_REDEFINITION.SYNC_INTERIM_TABLE('&1', 'TRANSMSG', 'TRANSMSGTMP');
 
-- Step 8, Finish redefinition.
exec DBMS_REDEFINITION.finish_redef_table('&1', 'TRANSMSG', 'TRANSMSGTMP');
