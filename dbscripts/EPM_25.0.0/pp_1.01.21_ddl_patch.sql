...
-----------------------------------
-- Created 06/29/2016 - Thomas Fidd
-- Possible memory issue, revert back change from script pp_1.01.08_ddl_patch.sql, 
-- store XMLTYPE field as CLOB rather than Binary.
...
SEGMENT CREATION IMMEDIATE 
 ...
 XMLTYPE COLUMN "FILEINFOXML" STORE AS BASICFILE CLOB "TRANSMSGFILE_LOB_INFOXML"(
