...
-- 02/24/2016 Thomas Fidd

ALTER TABLE PolicyVersion MODIFY maintenanceStartDateTime TIMESTAMP;
ALTER TABLE PolicyVersion MODIFY maintenanceEndDateTime TIMESTAMP;
ALTER TABLE PolicyMemberVersion MODIFY maintenanceStartDateTime TIMESTAMP;
ALTER TABLE PolicyMemberVersion MODIFY maintenanceEndDateTime TIMESTAMP;

ALTER TABLE policyMemberVersion MODIFY(exchangeMemberID VARCHAR2(50) NOT NULL);
