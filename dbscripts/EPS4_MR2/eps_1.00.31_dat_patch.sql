...
delete from ProcessedToDBStatusType
where processedToDBStatusTypeCd in ('A', 'H');


insert into ProcessedToDBStatusType (ProcessedToDBStatusTypeCd, ProcessedToDBStatusTypeNm, ProcessedToDBStatusTypeDesc) values ('B', 'Bypassed', 'Record bypassed after manual check');
