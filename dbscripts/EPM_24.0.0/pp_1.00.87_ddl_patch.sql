...
CREATE TABLE StagingPlanLock
(
	PlanId               VARCHAR2(50) NOT NULL ,
	batchId              NUMBER(19,0) NULL ,
	createDateTime       TIMESTAMP DEFAULT  systimestamp  NULL ,
	lastModifiedDateTime TIMESTAMP DEFAULT  systimestamp  NULL 
);

CREATE UNIQUE INDEX XPKStagingPlanLock ON StagingPlanLock
(PlanId   ASC);

ALTER TABLE StagingPlanLock
ADD CONSTRAINT  XPKStagingPlanLock PRIMARY KEY (PlanId);
