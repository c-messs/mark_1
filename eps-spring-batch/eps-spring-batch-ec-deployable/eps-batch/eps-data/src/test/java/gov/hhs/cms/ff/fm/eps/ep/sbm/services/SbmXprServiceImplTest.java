...
//	@Test
//	public void test_savePolicyToStaging_Eps_NoChange() throws InterruptedException {
//
...
//		
//		PolicyType policy2 = TestDataSBMUtility.makePolicyType(rcn, qhpId, exchangePolicyId);
//		
...
//	}
	...
	public void test_savePolicyToStaging_Cycle_2() throws InterruptedException {
		...
		// Make another policy with all the same data except for one member changings (MOM).  
	...
	private void verifySbmTransMsgStatus(String stateCd, String exchangePolicyId, SbmTransMsgStatus expectedStatus) {
		
		String sql = "SELECT SBMTRANSMSGPROCSTATUSTYPECD FROM SBMTRANSMSG WHERE " +
		"SUBSCRIBERSTATECD = '" + stateCd + "' AND EXCHANGEASSIGNEDPOLICYID = '" + exchangePolicyId +"'";
		String actualStatusCd = jdbc.queryForObject(sql, String.class);
		
		assertEquals ("SbmTransMsg ProcStatusTypeCd for sbmTransMsgId: " + stateCd + ": " + exchangePolicyId, 
				expectedStatus.getCode(), actualStatusCd);
	}
