...
public class PolicyMemberVersionPO extends GenericPolicyMemberPO<PolicyMemberVersionPO> {
	...
	private LocalDate policyMemberEligStartDate;
	private LocalDate policyMemberEligEndDate;
	private String subscriberInd;
	private LocalDate policyMemberBirthDate;
	 ...
	 */
	public LocalDate getPolicyMemberBirthDate() {
		return policyMemberBirthDate;
	}
	/**
	 * @param policyMemberBirthDate the policyMemberBirthDate to set
	 */
	public void setPolicyMemberBirthDate(LocalDate policyMemberBirthDate) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((exchangeMemberID == null) ? 0 : exchangeMemberID.hashCode());
		result = prime * result + ((issuerAssignedMemberID == null) ? 0 : issuerAssignedMemberID.hashCode());
		result = prime * result + ((policyMemberBirthDate == null) ? 0 : policyMemberBirthDate.hashCode());
		result = prime * result + ((policyMemberEligEndDate == null) ? 0 : policyMemberEligEndDate.hashCode());
		result = prime * result + ((policyMemberEligStartDate == null) ? 0 : policyMemberEligStartDate.hashCode());
		result = prime * result + ((policyMemberFirstNm == null) ? 0 : policyMemberFirstNm.hashCode());
		result = prime * result + ((policyMemberLastNm == null) ? 0 : policyMemberLastNm.hashCode());
		result = prime * result + ((policyMemberMiddleNm == null) ? 0 : policyMemberMiddleNm.hashCode());
		result = prime * result + ((policyMemberSSN == null) ? 0 : policyMemberSSN.hashCode());
		result = prime * result + ((policyMemberSalutationNm == null) ? 0 : policyMemberSalutationNm.hashCode());
		result = prime * result + ((policyMemberSuffixNm == null) ? 0 : policyMemberSuffixNm.hashCode());
		result = prime * result + ((subscriberInd == null) ? 0 : subscriberInd.hashCode());
		result = prime * result + ((x12GenderTypeCd == null) ? 0 : x12GenderTypeCd.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (policyMemberEligEndDate == null) {
			if (other.policyMemberEligEndDate != null)
				return false;
		} else if (!policyMemberEligEndDate.equals(other.policyMemberEligEndDate))
			return false;
		if (policyMemberEligStartDate == null) {
			if (other.policyMemberEligStartDate != null)
				return false;
		} else if (!policyMemberEligStartDate.equals(other.policyMemberEligStartDate))
			return false;
		...
		if (policyMemberSalutationNm == null) {
			if (other.policyMemberSalutationNm != null)
				return false;
		} else if (!policyMemberSalutationNm.equals(other.policyMemberSalutationNm))
			return false;
