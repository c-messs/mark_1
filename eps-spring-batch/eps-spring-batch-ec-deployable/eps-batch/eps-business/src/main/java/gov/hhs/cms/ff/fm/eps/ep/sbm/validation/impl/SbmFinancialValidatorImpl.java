...
public class SbmFinancialValidatorImpl implements SbmFinancialValidator {
	 ...
	 */
	private void validatePartialMonthStart(FinancialInformation financialInfo, LocalDate finStartDt,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validatePartialMonthEnd(FinancialInformation financialInfo, LocalDate finEndDt,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateProratedNodesSameMonth(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateProratedNodeAcrossMonths(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateProratedPremium(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
		...
		financialInfo.getProratedAmount().forEach(proratedAmount -> {
			...
			if(proratedAmount.getPartialMonthPremiumAmount().compareTo(financialInfo.getMonthlyTotalPremiumAmount()) > 0) {
				...
				prorationValidationErrors
						.add(SbmValidationUtil.createErrorWarningLogDTO("PartialMonthPremiumAmount",
	 ...
	 */
	private void validateAptcGreaterThanProratedTPA(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
		...
		financialInfo.getProratedAmount().forEach(proratedAmount -> {
			...
			if(financialInfo.getMonthlyAPTCAmount().compareTo(proratedAmount.getPartialMonthPremiumAmount()) > 0
				...
				prorationValidationErrors
						.add(SbmValidationUtil.createErrorWarningLogDTO("MonthlyAPTCAmount",
	 ...
	 */
	private void validateProratedAptc(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateProratedAptcGreaterThanTPA(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateProratedCSRVariant(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void calculateProratedCSR(FinancialInformation financialInfo, String metalLevel, String planYear, 
			List<SbmErrWarningLogDTO> prorationValidationErrors) {
	 ...
	 */
	private void validateFinancialNodes(List<FinancialInformation> financialInfoList, PolicyType policy,
			List<String> sbmBusinessRules, List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateFinStartEqPolicyStart(LocalDate finStartDt, LocalDate policyStartDt,
	 ...
	 */
	private void validateFinStartBeforePolicy(LocalDate finStartDt, LocalDate policyStartDt,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateFinEndEqPolicyEnd(LocalDate finEndDt, LocalDate policyEndDt,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateFinStartAfterPolicyEnd(LocalDate finStartDt, LocalDate policyEndDt,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateMonthlyAPTC(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateMonthlyTPA(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateCSRMissing(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateCSRVariant(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateNonCSRVariant(FinancialInformation financialInfo,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateSilverPlan(String variantId, String metalLevel,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
	 ...
	 */
	private void validateMetalLevelForCsr0203(String variantId, String metalLevel,
			List<SbmErrWarningLogDTO> financialValidationErrors) {
