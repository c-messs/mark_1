...
public class SbmXMLValidator {
	...
	private SBMXMLValidatorHandle1 sbmxmlValidatorHandle1;
	...
	public void setXsdFilePath(String xsdFilePath) throws ParserConfigurationException, SAXException, IOException {
		...
		if(sbmxmlValidatorHandle1==null){
			sbmxmlValidatorHandle1 =	new SBMXMLValidatorHandle1();
		}
		...
		sbmxmlValidatorHandle1.loadXMLElementsFromXSD(localXSDFile,validXMLElementMap,xmlOptionalElementsMap);
	}
