...
public class RAPJobFDDScenario8Test extends BaseRapBatchTest {
	...
	/*
	 * 5.2.8	Scenario 8: Retroactive Mid-Month Change
	 */
	@Test
	public void test_8() throws Exception {
		...
		DateTime coverage1 = JAN_1;
		DateTime erc1 = coverage1.minusDays(16); // DEC 16 
		DateTime initiation1 = coverage1.minusDays(12); // DEC 20

		DateTime coverage2 = FEB_1;
		DateTime erc2 = JAN_16;
		DateTime initiation2 = JAN_20;
		...
		DateTime maintStart = DateTime.now().minusSeconds(5); // NOV 30
		DateTime maintEnd = DateTime.now().minusSeconds(3);
		...
		Long exPolId = Long.valueOf("301");
		String issuerHiosId = "00001";
		...
		BigDecimal expectedPA_2 = new BigDecimal("100");
		...
		try {
			...
			DateTime esd2 = JAN_16;
			DateTime eed2 = null;
			BigDecimal aptc2 = new BigDecimal("100");
			...
			PolicyPaymentTrans ppt1 = makePolicyPaymentTrans(policyVersionId1, exPolId.toString(), initiation1, 
					RapConstants.TRNASPERIOD_PROSPECTIVE, RapConstants.STATUS_APPROVED, issuerHiosId, state);
			ppt1.setCoverageDate(JAN_1);
			ppt1.setFinancialProgramTypeCd(RapConstants.APTC);
			ppt1.setPaymentAmount(new BigDecimal("50"));
			...
			PolicyPaymentTrans ppt2 = makePolicyPaymentTrans(policyVersionId1, exPolId.toString(), initiation1,
					RapConstants.TRNASPERIOD_PROSPECTIVE, RapConstants.STATUS_APPROVED, issuerHiosId, state);
			ppt2.setCoverageDate(JAN_1);
			...
			ppt2.setTotalPremiumAmount(new BigDecimal("100"));

			insertPolicyPaymentTrans(batchId, ppt2);

			PolicyPaymentTrans ppt3 =  makePolicyPaymentTrans(policyVersionId1, exPolId.toString(), initiation2, 
					RapConstants.TRNASPERIOD_PROSPECTIVE, RapConstants.STATUS_APPROVED, issuerHiosId, state);
			ppt3.setCoverageDate(FEB_1);
			ppt3.setFinancialProgramTypeCd(RapConstants.APTC);
			ppt3.setPaymentAmount(new BigDecimal("50"));
			ppt3.setPaymentCoverageStartDate(FEB_1);
			ppt3.setPaymentCoverageEndDate(FEB_MAX);

			Long pptId3  = insertPolicyPaymentTrans(batchId, ppt3);

			PolicyPaymentTrans ppt4 =  makePolicyPaymentTrans(policyVersionId1, exPolId.toString(), initiation2, 
					RapConstants.TRNASPERIOD_PROSPECTIVE, RapConstants.STATUS_APPROVED, issuerHiosId, state);
			ppt4.setCoverageDate(FEB_1);
			ppt4.setFinancialProgramTypeCd(RapConstants.UF);
			ppt4.setPaymentAmount(new BigDecimal("-3.5"));
			ppt4.setPaymentCoverageStartDate(FEB_1);
			ppt4.setPaymentCoverageEndDate(FEB_MAX);
			ppt4.setTotalPremiumAmount(new BigDecimal("100"));

			insertPolicyPaymentTrans(batchId, ppt4);

			// Make expected payments (in ASC order)
			expectedParentPptId1 = pptId3;
			...
			assertStagingRapIssuer(stageId, issuerHiosId, 2);
