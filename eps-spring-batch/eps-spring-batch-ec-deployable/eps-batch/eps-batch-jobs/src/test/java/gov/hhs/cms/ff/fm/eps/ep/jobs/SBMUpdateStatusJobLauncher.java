...
@ContextConfiguration(locations={"/sbmUpdateStatus-batch-context.xml"})
@RunWith(SpringJUnit4ClassRunner.class)
@Ignore
public class SBMUpdateStatusJobLauncher {
	 ...
	 */	
	@Test
	public void testLaunchJob_sbmUpdateStatus() throws Exception {
